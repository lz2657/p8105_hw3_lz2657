...
The ny_noaa data is a dataframe with 2595176 observations of 7 variables. The variables include date <date>, prcp <int>, snow <int>, tmax <chr>, tmin<chr> and so on. An example of the observations is `r ny_noaa[496884,]`, which shows five core variables for a New York state weather station.